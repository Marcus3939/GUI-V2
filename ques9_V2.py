...
class Ui_ques9(QtWidgets.QWidget):
    ...
    def setupUi(self, ques9):
        ...
        ques9.resize(1046, 678)
        self.centralwidget = QtWidgets.QWidget(ques9)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(290, 300, 602, 231))
    ...
    def retranslateUi(self, ques9):
        ...
        ques9.setWindowTitle(_translate("ques9", "Question 9"))
        self.label.setText(_translate("ques9", "Question 9: I speak without a mouth and hear without ears. I have no body, but I come alive with wind."))
        self.R1.setText(_translate("ques9", "Trumpet"))
        self.R2.setText(_translate("ques9", "Echo"))
        self.R3.setText(_translate("ques9", "Microphone"))
        self.R4.setText(_translate("ques9", "Speaker"))
        self.B1.setText(_translate("ques9", "Continue"))
        self.label_3.setText(_translate("ques9", "Name: "))
        self.label_4.setText(_translate("ques9", "Remaining Time: "))
        ...
        self.B1.clicked.connect(ques9.close)
