...
class Ui_ques6(QtWidgets.QWidget):
    ...
    def retranslateUi(self, ques6):
        ...
        ques6.setWindowTitle(_translate("ques6", "Question 6"))
        self.label.setText(_translate("ques6", "Question 6: How many Rugby World Cups have New Zealand won?"))
        self.R1.setText(_translate("ques6", "five"))
        self.R2.setText(_translate("ques6", "three"))
        self.R3.setText(_translate("ques6", "eleven"))
        self.R4.setText(_translate("ques6", "nine"))
        self.B1.setText(_translate("ques6", "Continue"))
        self.label_3.setText(_translate("ques6", "Name: "))
        self.label_4.setText(_translate("ques6", "Remaining Time: "))
        ...
        self.B1.clicked.connect(ques6.close)
