...
class Ui_ques5(QtWidgets.QWidget):
    ...
    def retranslateUi(self, ques5):
        ...
        ques5.setWindowTitle(_translate("ques5", "Question 5"))
        self.label.setText(_translate("ques5", "Question 5: What do you call a 10 sided polygon? "))
        self.R1.setText(_translate("ques5", "Hexagon"))
        self.R2.setText(_translate("ques5", "Triangle"))
        self.R3.setText(_translate("ques5", "Decagon"))
        self.R4.setText(_translate("ques5", "Hendecagon"))
        self.B1.setText(_translate("ques5", "Continue"))
        self.label_3.setText(_translate("ques5", "Name: "))
        self.label_4.setText(_translate("ques5", "Remaining Time: "))
