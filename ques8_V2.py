...
class Ui_ques8(QtWidgets.QWidget):
    ...
    def retranslateUi(self, ques8):
        ...
        ques8.setWindowTitle(_translate("ques8", "Question 8"))
        self.label.setText(_translate("ques8", "Question 8: What is the circumference of the Earth?"))
        self.R1.setText(_translate("ques8", "20,000 km"))
        self.R2.setText(_translate("ques8", "40,075km"))
        self.R3.setText(_translate("ques8", "70,075 km"))
        self.R4.setText(_translate("ques8", "50,075 km"))
        self.B1.setText(_translate("ques8", "Continue"))
        self.label_3.setText(_translate("ques8", "Name: "))
        self.label_4.setText(_translate("ques8", "Remaining Time: "))
        ...
        self.B1.clicked.connect(ques8.close)
