...
class Ui_ques10(QtWidgets.QWidget):
    ...
    def retranslateUi(self, ques10):
        ...
        ques10.setWindowTitle(_translate("ques10", "Question 10"))
        self.label.setText(_translate("ques10", "Question 10: Who sang the song \'Never Gonna Give You Up\'"))
        self.R1.setText(_translate("ques10", "Lim Meng Wei"))
        self.R2.setText(_translate("ques10", "21 Savage"))
        self.R3.setText(_translate("ques10", "Micheal Jackson"))
        self.R4.setText(_translate("ques10", "Rick Astley"))
        self.B1.setText(_translate("ques10", "Continue"))
        self.label_3.setText(_translate("ques10", "Name: "))
        self.label_4.setText(_translate("ques10", "Remaining Time: "))
        ...
        self.B1.clicked.connect(ques10.close)
